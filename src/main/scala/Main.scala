...
object Main extends App {
  ...
  println("Problem12: " + new Problem12().run(Source.fromResource("12.txt").getLines.toList))
  println("Problem13: " + new Problem13().run(Source.fromResource("13.txt").mkString.trim))
}
